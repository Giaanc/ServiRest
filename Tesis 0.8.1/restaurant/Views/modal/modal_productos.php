          ...
          <div class="row">
            <div class="col-md-6">  
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="recipient-name" name="nombreInsumo" required="">
              </div>
              <div class="form-group">
                <label for="recipient-name" class="form-control-label">Stock:</label>
                <input type="number" class="form-control" id="recipient-name" name="stockInsumo" required="">
              </div>
              <div class="form-group">
                <label for="recipient-name" class="form-control-label">Costo:</label>
                <input type="number" class="form-control" id="recipient-name" name="costoInsumo" required="">
              </div>
            </div>
